 ...
 %>
		...
		<tr>
			<td align="center" colspan="2">
				<hr /> [ <a href="javascript:list()">리스트</a> <label>| 
				<% if (id == null) { %>
	<style>
		label {
			display: none;	
...
<% } %>
 <a href="update.jsp?nowPage=<%=nowPage%>&num=<%=num%>">수
					정</a> | <a href="reply.jsp?nowPage=<%=nowPage%>">답 변</a> |
				<a href="delete.jsp?nowPage=<%=nowPage%>&num=<%=num%>">삭
					제</a> </label>]<br />
			</td>
		</tr>
	</table>
