...
<jsp:useBean id="bBean" class="member.BoardBean" />
<%
				...
				<tr>
					<td align=center>
						<table align="center">
							<tr>
								<td width="10%">성 명</td>
								<td width="90%"><input name="name" size="10" maxlength="8"
									value="<%=id%>"></td>
							</tr>
							<tr>
								<td>제 목</td>
								<td><input size="50" maxlength="30" name="subject" required></td>
							...
							<tr>
								...
								<%
								bBean.setSecret(request.getParameter("secret"));
								%>
							</tr>
							<tr>
								<td colspan="2"><hr /></td>
